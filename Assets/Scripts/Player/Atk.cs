...
public partial class Player : MonoBehaviour
{
    ...
    public int atk1_dmg => Mathf.RoundToInt(Atk1_Damage * Stre_Buff);
    public int atk2_dmg => Mathf.RoundToInt(Atk2_Damage * Stre_Buff);
    public int atk3_dmg => Mathf.RoundToInt(Atk3_Damage * Stre_Buff);
